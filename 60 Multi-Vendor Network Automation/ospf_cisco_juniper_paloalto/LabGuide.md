...
### Lab guide:
Steps:
1. Create device_vars.py and add below command.
...
```
2. Create configurations.py and add below command
```python
# configurations.py
...
```
3. Create ospf_config.py and add below config.
...
3. Checking current state of lab.

    login to all devices and check current ospf config.
